...
import { AdvancedSetting } from '~/modules/dashboard/posts/components/edit/sheet/AdvancedSetting'

import { PagesBasicSetting } from './sheet/PagesBasicSetting'

export const PageEditorToolsArea = () => {
  return (
